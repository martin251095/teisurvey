...
abstract class AbstractDoctrineExtension extends Extension
{
    ...
    /**
     * Registration the alias for this mapping driver.
     *
    ...
    /**
     * Registration the mapping driver configuration for later use with the object managers metadata driver chain.
     *
     * @param array  $mappingConfig
     * @param string $mappingName
     *
    ...
    /**
     * Registration all the collected mapping information with the object manager by registering the appropriate mapping drivers.
     *
