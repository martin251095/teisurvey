...
class __TwigTemplate_db5ee14add5b5b46be33852b5873905cd9d46dbf6735935d0e36c10ac0c497f4 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("admin/base.html.twig", "admin/category/add.html.twig", 1);
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["locale"]) {
            ...
            b = document.forms[\"category_tree\"][\"category_tree[name\" + upperLocale + \"]\"].value;
            if (b==null || b===\"\") {
                alert(\"Please fill all required field, don't forget the translations into the tabs\");
                return false;
            }
    ...
    <div class=\"container\">
        <h3 class=\"admin-h3\">Add new category</h3>
        ";
        // line 34
