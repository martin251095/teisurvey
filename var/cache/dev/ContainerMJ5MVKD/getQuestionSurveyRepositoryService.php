...
// Returns the private 'App\Repository\QuestionSurveyRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/QuestionSurveyRepository.php';

return $this->privates['App\\Repository\\QuestionSurveyRepository'] = new \App\Repository\QuestionSurveyRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
