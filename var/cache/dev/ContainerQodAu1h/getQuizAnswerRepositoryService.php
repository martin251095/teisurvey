...
// Returns the private 'App\Repository\QuizAnswerRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/QuizAnswerRepository.php';

return $this->privates['App\\Repository\\QuizAnswerRepository'] = new \App\Repository\QuizAnswerRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
