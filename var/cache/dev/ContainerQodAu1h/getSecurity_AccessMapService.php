...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/[a-z]{2}/quiz'), [0 => 'IS_AUTHENTICATED_ANONYMOUSLY'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/[a-z]{2}/thanks'), [0 => 'IS_AUTHENTICATED_ANONYMOUSLY'], NULL);
