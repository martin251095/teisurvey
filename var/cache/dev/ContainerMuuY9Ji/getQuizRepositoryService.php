...
// Returns the private 'App\Repository\QuizRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/QuizRepository.php';

return $this->privates['App\\Repository\\QuizRepository'] = new \App\Repository\QuizRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
