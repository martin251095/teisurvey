...
// Returns the private 'App\Repository\AnswerSurveyRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AnswerSurveyRepository.php';

return $this->privates['App\\Repository\\AnswerSurveyRepository'] = new \App\Repository\AnswerSurveyRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
