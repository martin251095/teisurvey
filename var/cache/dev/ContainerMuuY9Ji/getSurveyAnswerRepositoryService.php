...
// Returns the private 'App\Repository\SurveyAnswerRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/SurveyAnswerRepository.php';

return $this->privates['App\\Repository\\SurveyAnswerRepository'] = new \App\Repository\SurveyAnswerRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
